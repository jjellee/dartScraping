...
def check_string(input_string):
    ...
    contains_required = '단일판매' in input_string or '신규시설투자' in input_string or '손익구조30%' in input_string or '공정공시' in input_string
...
bot.send_message(chat_id, 'restart')
